...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f010a7fd-4865-4abf-ad38-fd04624b7af7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9aa48f46-5c2d-45a0-a448-694f6972e65c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("38df6223-84ff-4eeb-b355-a1a678e62f9c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_GPIO0_net;
	wire [0:0] tmpFB_0__LED_GPIO0_net;
	wire [0:0] tmpIO_0__LED_GPIO0_net;
	wire [0:0] tmpINTERRUPT_0__LED_GPIO0_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO0_net;

	cy_psoc3_pins_v1_10
		#(.id("5bad754e-5c7f-4e02-85d1-9289db291ea8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_GPIO0
		 (.oe(tmpOE__LED_GPIO0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO0_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO0_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO0_net),
		  .interrupt({tmpINTERRUPT_0__LED_GPIO0_net[0:0]}),
		  .annotation({Net_151}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_GPIO0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_GPIO1_net;
	wire [0:0] tmpFB_0__LED_GPIO1_net;
	wire [0:0] tmpIO_0__LED_GPIO1_net;
	wire [0:0] tmpINTERRUPT_0__LED_GPIO1_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO1_net;

	cy_psoc3_pins_v1_10
		#(.id("f7671d31-7ee9-47c3-b4a9-2eddbe83f3a9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_GPIO1
		 (.oe(tmpOE__LED_GPIO1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO1_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO1_net),
		  .interrupt({tmpINTERRUPT_0__LED_GPIO1_net[0:0]}),
		  .annotation({Net_152}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_GPIO1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_GPIO2_net;
	wire [0:0] tmpFB_0__LED_GPIO2_net;
	wire [0:0] tmpIO_0__LED_GPIO2_net;
	wire [0:0] tmpINTERRUPT_0__LED_GPIO2_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO2_net;

	cy_psoc3_pins_v1_10
		#(.id("8657807a-c8e2-42c4-930e-23bd2cb73402"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_GPIO2
		 (.oe(tmpOE__LED_GPIO2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO2_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO2_net),
		  .interrupt({tmpINTERRUPT_0__LED_GPIO2_net[0:0]}),
		  .annotation({Net_153}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_GPIO2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_GPIO3_net;
	wire [0:0] tmpFB_0__LED_GPIO3_net;
	wire [0:0] tmpIO_0__LED_GPIO3_net;
	wire [0:0] tmpINTERRUPT_0__LED_GPIO3_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO3_net;

	cy_psoc3_pins_v1_10
		#(.id("a63a2932-714b-4750-af00-b1f7df678022"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_GPIO3
		 (.oe(tmpOE__LED_GPIO3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO3_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO3_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO3_net),
		  .interrupt({tmpINTERRUPT_0__LED_GPIO3_net[0:0]}),
		  .annotation({Net_154}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_GPIO3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("edee0385-4224-47f8-9e93-598da0f7db0a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f46772e6-2dc3-423e-891b-36b1d67ba2e8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_GPIO4_net;
	wire [0:0] tmpFB_0__LED_GPIO4_net;
	wire [0:0] tmpIO_0__LED_GPIO4_net;
	wire [0:0] tmpINTERRUPT_0__LED_GPIO4_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO4_net;

	cy_psoc3_pins_v1_10
		#(.id("53fafc31-6afd-470f-b40e-b82e9337c063"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_GPIO4
		 (.oe(tmpOE__LED_GPIO4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO4_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO4_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO4_net),
		  .interrupt({tmpINTERRUPT_0__LED_GPIO4_net[0:0]}),
		  .annotation({Net_159}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_GPIO4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_GPIO5_net;
	wire [0:0] tmpFB_0__LED_GPIO5_net;
	wire [0:0] tmpIO_0__LED_GPIO5_net;
	wire [0:0] tmpINTERRUPT_0__LED_GPIO5_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO5_net;

	cy_psoc3_pins_v1_10
		#(.id("800976f5-6b39-423c-bf2e-21835f1b493f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_GPIO5
		 (.oe(tmpOE__LED_GPIO5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO5_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO5_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO5_net),
		  .interrupt({tmpINTERRUPT_0__LED_GPIO5_net[0:0]}),
		  .annotation({Net_160}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_GPIO5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
